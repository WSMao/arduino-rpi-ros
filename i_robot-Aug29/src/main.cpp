...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber ros_mega2_sub = n.subscribe ("Mega2toRos_topic",300, Mega2Ros_Cb);

 // i_robot::ROS_MEGA2_msg mega2_message;
  ros::Publisher ros_mega2_pub = n.advertise<i_robot::ROS_MEGA2_msg> ("RostoMega2_topic",300);
